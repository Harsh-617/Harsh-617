...
/* flex-basis: auto;: This sets the initial size of the flex item based on its content or any width/height properties set on it   */         
            ...
            <div class="H">
                ...
                <div class="columns">
                    ...
                    <div class="column"> <div class="fs"> <a href="mailto:harshkudu67@gmail.com"> <i class="fas fa-envelope" aria-hidden="true"></i> </a> </div></div>
                    <div class="column"> <div class="fs"> <a href="www.linkedin.com/in/harsh-kudu-9389a2340" target="_blank"> <i class="fab fa-linkedin" aria-hidden="true"></i> </a> </div></div>
                </div>
